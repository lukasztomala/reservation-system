...
Pamiętaj, aby zapisać swój plan wdrożenia jako .ai/api/[endpoint]-[method]-implementation-plan.md. Upewnij się, że plan jest szczegółowy, przejrzysty i zapewnia kompleksowe wskazówki dla zespołu programistów.